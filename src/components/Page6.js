        ...
        <div className="col-12 col-lg-6">
          <form>
            <div className="mb-3">
              ...
              <input type="text" className="form-control border shadow-sm" id="name" />
            </div> 
            <div className="mb-3">
              <label htmlFor="email" className="form-label">Email Address<span className="text-danger"> *</span></label>
              <input type="email" className="form-control border shadow-sm" id="email" />
            </div>
            <div className="mb-3">
              <label htmlFor="phone" className="form-label">Phone</label>
              <input type="tel" className="form-control border shadow-sm" id="phone" />
            </div>
            <div className="mb-3">
              <label htmlFor="message" className="form-label">Your Message/Question</label>
              <textarea className="form-control" id="message border shadow-sm" rows="9"></textarea>
            </div>
